...
This is a minimal implementation of the AFNI [3dAllineate](https://afni.nimh.nih.gov/pub/dist/doc/program_help/3dAllineate.html) tool. It removes AFNI dependencies, removes rarely used functions and provide optimization.
